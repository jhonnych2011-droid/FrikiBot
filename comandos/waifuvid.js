...
export async function run(sock, msg, args) {
  ...
  try {
    ...
    // --- 3. Enviando con el MIME Type estándar para GIFs en WhatsApp ---
    console.log(`[${commandName}] - 5. Enviando mensaje como VIDEO/GIF con MIME MP4...`);
    
    await sock.sendMessage(from, {
      video: mediaBuffer, 
      caption: `🔞 *¡Video NSFW solicitado!* (Categoría: Blowjob)`,
      mimetype: 'video/mp4', // <--- MimeType estándar para GIFs en WhatsApp
      gifPlayback: true 
    }, { quoted: msg });
